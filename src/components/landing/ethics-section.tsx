...
export function EthicsSection({ dictionary }: EthicsSectionProps) {
  const ethics = dictionary.landing.ethics;
      ...
      <Container>
        <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
          ...
          <div className="grid gap-4">
            {ethics.assessmentPrinciples.map((principle, index) => (
        ...
        <div className="grid gap-5 md:grid-cols-3">
          {ethics.aiPrinciples.map((principle) => (
